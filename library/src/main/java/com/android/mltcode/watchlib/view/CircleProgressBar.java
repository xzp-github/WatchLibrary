...
public class CircleProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = SizeUtils.dp2px(mContext, DEFAULT_SIZE);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mPrecisionFormat = SizeUtils.getPrecisionFormat(mPrecision);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(SizeUtils.measure(widthMeasureSpec, mDefaultSize),
                SizeUtils.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    public void setPrecision(int precision) {
        ...
        mPrecisionFormat = SizeUtils.getPrecisionFormat(precision);
    }
